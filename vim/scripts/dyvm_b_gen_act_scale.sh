...
#SBATCH --job-name=dyvm_b_act_scale
#SBATCH --output=/u/chenjoachim/log/dyvm_b_act_scale_%j.out
#SBATCH --error=/u/chenjoachim/log/dyvm_b_act_scale_%j.err
...
python vim/generate_act_scale.py \
  ...
  --batch-size 256 \
  --num_workers 2 \
  --scales-output-path ./act_scales/dyvm_b_imnet_subset/
