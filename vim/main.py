...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'IMAGENETTE'],
...
def main(args):
    ...
    dataset_val, val_nb_classes = build_dataset(is_train=False, args=args)
    if args.eval:
        args.nb_classes = val_nb_classes
